...
with open(output_file, mode="w", newline="") as file:
    ...
    for image_file in image_files:
        ...
        x1, y1, x2, y2 =  (366, 12, 655, 51)# Coordenadas de uma imagem de 1100x600, coordenadas obtidas através de recorte.py
        ...
        for dado in dados_interessantes:
            ...
            segundos = texto_limpo[8:].zfill(2)
                ...
                # Verifique se os valores são numéricos e mantenha o sinal de menos e a vírgula
